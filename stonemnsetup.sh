...
function create_key() {
  ...
  if [ "$?" -gt "0" ];
    ...
    echo -e "${RED}This will take some time...${NC}"
    sleep 300
    COINKEY=$($COIN_PATH$COIN_CLI masternode genkey)
  fi
...
function upgradeInfo() {
  clear
  echo -e "${BLUE}============================================================${NC}"
  echo -e "${GREEN}   \$\$\$\$\$${NC}${CYAN}  TTTTTTT  OOOOO  NN   NN EEEEEEE    ${NC}${GREEN}\$\$\$\$\$  ${NC}"
  echo -e    "${GREEN}  \$\$${NC}${CYAN}        TTT   OO   OO NNN  NN EE      C  ${NC}${GREEN}\$\$      ${NC}"
  echo -e "${GREEN}   \$\$\$\$\$${NC}${CYAN}    TTT   OO   OO NN N NN EEEEE   C   ${NC}${GREEN}\$\$\$\$\$  ${NC}"
  echo -e    "${GREEN}       \$\$${NC}${CYAN}   TTT   OO   OO NN  NNN EE      C    ${NC}${GREEN}\$\$ ${NC}"
  echo -e "${GREEN}   \$\$\$\$\$${NC}${CYAN}    TTT    OOOO0  NN   NN EEEEEEE    ${NC}${GREEN}\$\$\$\$\$  ${NC}"
  echo -e "${BLUE}============================================================${NC}"
  echo -e "${BLUE}============================================================${NC}"
